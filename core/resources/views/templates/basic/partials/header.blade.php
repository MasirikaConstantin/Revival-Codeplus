...
<header class="header" id="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <a class="navbar-brand logo d-lg-none d-block" href="{{ route('home') }}" style="display:flex;align-items:center;max-height:40px;padding:0;">
                <img src="{{ siteLogo() }}" alt="@lang('Image')" style="height:32px;max-height:32px;width:auto;object-fit:contain;">
            </a>
