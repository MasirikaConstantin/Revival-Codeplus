...
<section class="additional-benefit py-120 bg-img"
    data-background-image="{{ frontendImage('banner', 'bg.png', '1920x850') }}">
    <div class="container">
        <div class="row gy-4 flex-wrap-revese">
            <div class="col-lg-6">
                <div class="additional-benefit__thumb">
                    <img src="{{ frontendImage('additional_benefit', @$benefit->data_values->image, '635x470') }}"
                        alt="@lang('Image')">
                    ...
                    <img src="{{ asset($activeTemplateTrue . 'images/curve-shape.png') }}" alt="@lang('Image')"
                        class="additional-benefit__element one">
                    <img src="{{ asset($activeTemplateTrue . 'images/additional-benefit-shape2.png') }}"
                        alt="@lang('Image')" class="additional-benefit__element two">
                </div>
            </div>
            <div class="col-lg-6">
