...
class PaymentController extends Controller {
    ...
    public function depositInsert(Request $request) {
        ...
        $data->btc_wallet      = "";
        $data->trx             = getTrx();
        $data->success_url     = route('user.author.download');
    ...
    private function orderFromAccountBalance($order) {
        ...
        foreach ($order->orderItems as $orderItem) {
            $sellerEarning       = ($orderItem->product_price + $orderItem->extended_amount) - $orderItem->discount;
    ...
    private function createOrder($cartItems) {
        ...
        foreach ($cartItems as $cartItem) {
            ...
            $orderItem->seller_earning  = ($cartItem->price - ($sellerFee + $cartItem->discount)) + $cartItem->extended_amount;
